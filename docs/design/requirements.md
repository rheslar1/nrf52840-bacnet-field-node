# nRF52840 BACnet Field Node Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for nRF52840 BACnet Field Node. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Battery-aware field device profile with persistent setpoint storage, commissioning evidence, and BACnet object mapping. | Scenario tests and documentation review. |
